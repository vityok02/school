    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PositionSchool", x => new { x.PositionsId, x.SchoolsId });
                    table.ForeignKey(
                        name: "FK_PositionSchool_Positions_PositionsId",
                        column: x => x.PositionsId,
                        principalTable: "Positions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PositionSchool_Schools_SchoolsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Floors_Number_SchoolId",
                table: "Floors",
                columns: new[] { "Number", "SchoolId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Floors_SchoolId",
                table: "Floors",
                column: "SchoolId");

            migrationBuilder.CreateIndex(
                name: "IX_PositionSchool_SchoolsId",
                table: "PositionSchool",
                column: "SchoolsId");
